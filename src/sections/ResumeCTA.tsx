      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <TiltCard maxTilt={6} glareOpacity={0.35}>
          <motion.div
            ...
            className="relative rounded-3xl overflow-hidden glass-card-3d border border-primary-500/40 p-8 sm:p-14 shadow-2xl backdrop-blur-2xl"
          >
            {/* Ambient Lighting Volumetric Glows */}
            <div className="absolute -top-32 -right-32 w-96 h-96 bg-accent-cyan/20 rounded-full blur-[110px] pointer-events-none" />
            <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-primary-600/25 rounded-full blur-[110px] pointer-events-none" />

            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              {/* Left Narrative & 3D Document Highlights (8 cols) */}
              <div className="lg:col-span-8 space-y-5 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-primary-500/20 text-primary-300 border border-primary-500/40 shadow-md backdrop-blur">
                  <FileText className="w-3.5 h-3.5 text-accent-cyan" />
                  <span>Curriculum Vitae & Credentials</span>
                </div>

                <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white dark:text-white light:text-slate-900 tracking-tight leading-[1.15]">
