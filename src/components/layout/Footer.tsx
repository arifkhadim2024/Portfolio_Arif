...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#05070B] dark:bg-[#05070B] light:bg-slate-100 border-t border-slate-800/80 dark:border-slate-800/80 light:border-slate-300 pt-16 pb-12 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-slate-800/80 dark:border-slate-800/80 light:border-slate-200">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-primary-600 via-primary-500 to-accent-cyan flex items-center justify-center font-bold text-white text-sm shadow-md">
                AK
              </div>
